        ...
        <div class="card">
              ...
              <div class="container">
                ...
                <form method="post" action="removeseller.php">
                    <b> Search the Seller</b>
                    <input type="text" placeholder=" Valid User Name " id="someID" name="search">
                    <div id="result"></div>
              ...
              <form method="post" action="/webdevelopment/html/removesellerdb.php">
                <script>
                function a(){
                ...
                <label for="Sname" ><b>Selected Seller</b></label>
                <input type="text"  placeholder="Enter User Name Name" id="SELECTEDID" name="sname" required>
